  ...
  return (
    <>
      ...
      <div className="relative z-40 lg:hidden">
        {isMobileOpen && (
          <div className="fixed inset-0 bg-[rgba(6,35,31,0.82)] backdrop-blur-sm" />
        )}
        
        {/* Mobile sidebar */}
        <div className={`fixed inset-y-0 left-0 z-50 w-64 border-r border-[rgba(212,175,55,0.18)] bg-[rgba(6,35,31,0.94)] shadow-[0_28px_80px_rgba(0,0,0,0.34)] backdrop-blur transform transition-transform duration-300 ease-in-out ${
      ...
      <div className="lg:hidden mobile-menu-container">
        <button
          onClick={toggleMobileMenu}
          className="fixed top-4 left-4 z-50 rounded-xl border border-[rgba(212,175,55,0.22)] bg-[rgba(6,35,31,0.9)] p-2 shadow-[0_18px_48px_rgba(0,0,0,0.28)] backdrop-blur"
        >
